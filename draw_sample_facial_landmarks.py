...
def draw_landmarks(img, landmarks):
    ...
    for idx, point in enumerate(landmarks):
        ...
        #print(idx, position)
        cv2.circle(land_img, position, 3, color=(0, 0, 255), thickness=-1)
...
def main():
    ...
    #src_dir = "/home/liuliang/DISK_2T/datasets/ExpW/data/image/origin"
    src_dir = "/home/liuliang/Desktop"
    des_dir = "/home/liuliang/Desktop/landmarks_sample"

    detector = dlib.get_frontal_face_detector()
    predictor = dlib.shape_predictor('shape_predictor_68_face_landmarks.dat')

    img_ids = list(filter(lambda x: x.endswith('.jpg') or x.endswith('.png'), os.listdir(src_dir)))
    img_ids.sort()
    cnt = len(img_ids)
